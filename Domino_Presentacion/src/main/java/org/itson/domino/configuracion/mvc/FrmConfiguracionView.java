...
public class FrmConfiguracionView extends javax.swing.JFrame implements IView{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmConfiguracionView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmConfiguracionView().setVisible(true);
            }
        });
    }
